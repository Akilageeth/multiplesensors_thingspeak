...
String apiKey = "EESKYJFS48N3FCD2";     //  Enter your Write API key here
const char* server = "api.thingspeak.com";
const char *ssid =  "SLT-4G-76DE";     // Enter your WiFi Name
const char *pass =  "1TQ1LAJ8F4H"; // Enter your WiFi Password
